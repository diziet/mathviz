...
- **69 generators** across 12 categories (attractors, fractals, knots, parametric surfaces, and more)
...
| fractals | 6 | `apollonian_3d`, `fractal_slice`, `julia3d`, `mandelbrot_heightmap`, `mandelbulb`, `menger_sponge` | 3D fractals and fractal heightmaps |
