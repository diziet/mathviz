...
- **78 generators** across 12 categories (attractors, fractals, knots, parametric surfaces, and more)
...
| physics | 5 | `kepler_orbit`, `nbody`, `planetary_positions`, `electron_orbital`, `gravitational_lensing` | Physics simulations |
